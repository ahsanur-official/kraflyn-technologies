            ...
            {filteredServices.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-3xl border border-slate-200 p-5 shadow-xs hover:shadow-xl hover:border-blue-300 transition-all flex flex-col justify-between group relative overflow-hidden"
                >
                  {/* Top Accent bar */}
                  ...
                  <div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 text-blue-600 flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-xs shrink-0">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <motion.button
                        ...
                        className="py-2.5 px-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1 shadow-md shadow-blue-500/20 transition-all cursor-pointer"
                      >
