        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="inline-flex items-center max-w-full">
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-blue-500/15 border border-blue-400/30 text-blue-300 text-[11px] sm:text-sm font-semibold backdrop-blur-md shadow-lg shadow-blue-500/10 max-w-full">
            ...
            <motion.h1 
              ...
              className="text-2xl xs:text-3xl sm:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black tracking-tight text-white leading-[1.18] sm:leading-[1.12] break-words"
            >
              {t.heroTitle1} <br />
            ...
            >
              <motion.button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-black text-sm sm:text-base rounded-2xl shadow-xl shadow-blue-600/30 flex items-center justify-center gap-2.5 cursor-pointer smooth-card-transition"
              >
              ...
              <motion.button
                ...
                className="w-full sm:w-auto px-7 py-4 bg-white/10 border border-white/20 text-white font-bold text-sm sm:text-base rounded-2xl backdrop-blur-md flex items-center justify-center gap-2 cursor-pointer transition-all duration-300"
              >
            ...
            >
              <motion.div 
                ...
                className="p-3.5 sm:p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-400/40 hover:bg-white/8 backdrop-blur-xs transition-all duration-300 cursor-default shadow-xs hover:shadow-lg hover:shadow-blue-500/10"
              >
              ...
              <motion.div 
                whileHover={{ scale: 1.025, y: -3 }}
                transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
                className="p-3.5 sm:p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-emerald-400/40 hover:bg-white/8 backdrop-blur-xs transition-all duration-300 cursor-default shadow-xs hover:shadow-lg hover:shadow-emerald-500/10"
              >
              ...
              <motion.div 
                whileHover={{ scale: 1.025, y: -3 }}
                transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
                className="p-3.5 sm:p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-sky-400/40 hover:bg-white/8 backdrop-blur-xs transition-all duration-300 cursor-default shadow-xs hover:shadow-lg hover:shadow-sky-500/10"
              >
              ...
              <motion.div 
                whileHover={{ scale: 1.025, y: -3 }}
                transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
                className="p-3.5 sm:p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-amber-400/40 hover:bg-white/8 backdrop-blur-xs transition-all duration-300 cursor-default shadow-xs hover:shadow-lg hover:shadow-amber-500/10"
              >
          ...
          >
            ...
            <motion.div 
              ...
              className="bg-gradient-to-b from-slate-800/95 to-slate-900/95 border border-slate-700/80 hover:border-blue-500/30 rounded-3xl p-6 sm:p-7 shadow-2xl backdrop-blur-xl space-y-5 transition-all duration-300"
            >
              ...
              {/* 3 Step Snapshot with Silky Smooth Hover Transitions */}
              <div className="space-y-3">
                <motion.div 
                  whileHover={{ x: 5, backgroundColor: "rgba(30, 41, 59, 0.9)" }}
                  transition={{ duration: 0.25, ease: [0.16, 1, 0.3, 1] }}
                  className="bg-slate-800/70 border border-slate-700/60 rounded-2xl p-3.5 flex items-start gap-3 transition-colors hover:border-blue-500/40 cursor-default"
                >
                ...
                <motion.div 
                  whileHover={{ x: 5, backgroundColor: "rgba(30, 41, 59, 0.9)" }}
                  transition={{ duration: 0.25, ease: [0.16, 1, 0.3, 1] }}
                  className="bg-slate-800/70 border border-slate-700/60 rounded-2xl p-3.5 flex items-start gap-3 transition-colors hover:border-emerald-500/40 cursor-default"
                >
                ...
                <motion.div 
                  whileHover={{ x: 5, backgroundColor: "rgba(30, 41, 59, 0.9)" }}
                  transition={{ duration: 0.25, ease: [0.16, 1, 0.3, 1] }}
                  className="bg-slate-800/70 border border-slate-700/60 rounded-2xl p-3.5 flex items-start gap-3 transition-colors hover:border-indigo-500/40 cursor-default"
                >
              ...
              <div className="pt-2">
                <motion.button
                  ...
                  className="w-full py-3 px-3 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-600 hover:border-blue-400 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer shadow-xs"
                >
