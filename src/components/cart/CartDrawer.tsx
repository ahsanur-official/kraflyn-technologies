            ...
            {cartItems.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12">
                ...
                <p className="text-xs text-slate-500 max-w-xs mt-1 leading-relaxed">
                  কোর্স সহায়তা, ল্যাব ডিবাগিং, থিসিস বা ভাইভা প্রিপারেশন সার্ভিস সিলেক্ট করে কার্টে যোগ করুন।
                </p>
                <button
                  onClick={closeCart}
                  className="mt-6 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-sm transition-colors cursor-pointer"
                >
              ...
              <>
                  ...
                  >
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-100">
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        ...
                        >
                          <div className="leading-tight font-bold">Standard</div>
                          <div className="text-[10px] text-slate-500 mt-0.5">Normal Deadline</div>
                        </button>
                    ...
                    <div className="mt-3 pt-2 flex items-center justify-between text-xs text-slate-500">
                      <span className="flex items-center gap-1 text-[11px] text-emerald-700 font-medium">
                        <Clock className="w-3 h-3" /> 1-on-1 Mentor Guidance
                      </span>
                ...
                <div className="bg-emerald-50/80 border border-emerald-200 rounded-xl p-3.5 flex items-start gap-2.5">
                  ...
                  <div className="text-xs text-emerald-900 leading-relaxed">
                    <strong className="block font-bold">100% ডেলিভারি নিশ্চয়তা</strong>
                    অর্ডার প্লেস করার পর আমাদের টিম WhatsApp/ফোনে যোগাযোগ করে বিস্তারিত জেনে আপনার পছন্দের মেন্টর দিয়ে কাজ শুরু করবে।
                  </div>
                </div>
              </>
            )}
          ...
          {cartItems.length > 0 && (
            <div className="p-6 border-t border-slate-200 bg-slate-50/80 space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-600 font-medium">Estimated Total (আনুমানিক ফি):</span>
              ...
              >
                <span>অর্ডার সম্পন্ন করতে এগিয়ে যান (Order Now)</span>
              ...
              <div className="flex items-center justify-center gap-2 pt-1 text-[11px] text-slate-500">
                ...
                <span>সরাসরি হেল্পলাইন: <strong>+880 1712-345678</strong></span>
              </div>
            </div>
          )}
