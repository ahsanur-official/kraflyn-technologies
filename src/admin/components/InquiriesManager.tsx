...
export const InquiriesManager: React.FC = () => {
  const { inquiries, language, showToast } = useApp();
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl md:text-2xl font-black text-slate-900">
              {language === 'bn' ? 'শিক্ষার্থী ইনকোয়ারি ও মেসেজ' : 'Student Inquiries & Messages'}
            </h1>
          </div>
          <p className="text-xs md:text-sm text-slate-500 mt-1">
            {language === 'bn' 
              ? 'যোগাযোগ ফর্ম থেকে পাঠানো সকল শিক্ষার্থীর অনুসন্ধান বার্তা পরিচালনা ও রিপ্লাই দিন।' 
              : 'Review, track and follow up on contact inquiries submitted by students.'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-xs flex flex-col sm:flex-row items-center gap-3">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            placeholder={language === 'bn' ? 'শিক্ষার্থীর নাম, ফোন, ইমেইল বা বিষয় দিয়ে খুঁজুন...' : 'Search by student name, phone, or subject...'}
      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-2xl p-12 text-center border border-dashed border-slate-300">
          ...
          <p className="text-xs text-slate-500 mt-1">
            {language === 'bn' ? 'শিক্ষার্থীরা মেসেজ পাঠালে এখানে দেখতে পাবেন।' : 'Student contact inquiries will appear here.'}
          </p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-end gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 py-2 text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl flex items-center gap-1.5 shadow-md shadow-emerald-500/20"
                >
                  <MessageSquare className="w-3.5 h-3.5" />
